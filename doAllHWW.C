...
void doAllHWW(RunEra runEra = RUN2012)
{
    ...
    bool run135 = 0;
    bool run140 = 0;
    //    bool run145 = 0; // do not turn on
    bool run150 = 0;
    //    bool run155 = 0; // do not turn on
    bool run160 = 0;
    bool run170 = 0;
    bool run180 = 0;
    bool run190 = 0;
    ...
    //
    //runEra = RUN2012HCP;
    runEra = RUN2012Moriond;
    if ( runSSCTL)      {
        makePlots_ = false;
        doMassPoint(0.0, HWW_OPT_SSCTL, runEra);
    }
    if ( runTOPTAG )    doMassPoint(0.0, HWW_OPT_TOPTAG, runEra);
    if ( runWWXsec )    doMassPoint(0.0, WW_OPT_SMURFXSECSEL, runEra);
    if ( runWW )        doMassPoint(0.0, HWW_OPT_SMURFPRESEL, runEra);

    //-- cut based ---------------------------------------------------  
    if (doCUT) {
        if ( run110)    doMassPoint(110.0, HWW_OPT_SMURFCUTSEL, runEra);
        if ( run115)    doMassPoint(115.0, HWW_OPT_SMURFCUTSEL, runEra);
        if ( run120)    doMassPoint(120.0, HWW_OPT_SMURFCUTSEL, runEra);
        if ( run125)    doMassPoint(125.0, HWW_OPT_SMURFCUTSEL, runEra);
        if ( run130)    doMassPoint(130.0, HWW_OPT_SMURFCUTSEL, runEra);
        if ( run135)    doMassPoint(135.0, HWW_OPT_SMURFCUTSEL, runEra);
        if ( run140)    doMassPoint(140.0, HWW_OPT_SMURFCUTSEL, runEra);
        //      if ( run145)    doMassPoint(145.0, HWW_OPT_SMURFCUTSEL, runEra);
        if ( run150)    doMassPoint(150.0, HWW_OPT_SMURFCUTSEL, runEra);
        //      if ( run155)    doMassPoint(155.0, HWW_OPT_SMURFCUTSEL, runEra);
        if ( run160)    doMassPoint(160.0, HWW_OPT_SMURFCUTSEL, runEra);
        if ( run170)    doMassPoint(170.0, HWW_OPT_SMURFCUTSEL, runEra);
        if ( run180)    doMassPoint(180.0, HWW_OPT_SMURFCUTSEL, runEra);
        if ( run190)    doMassPoint(190.0, HWW_OPT_SMURFCUTSEL, runEra);
        if ( run200)    doMassPoint(200.0, HWW_OPT_SMURFCUTSEL, runEra);
        if ( run250)    doMassPoint(250.0, HWW_OPT_SMURFCUTSEL, runEra);
        if ( run300)    doMassPoint(300.0, HWW_OPT_SMURFCUTSEL, runEra);
        if ( run350)    doMassPoint(350.0, HWW_OPT_SMURFCUTSEL, runEra);
        if ( run400)    doMassPoint(400.0, HWW_OPT_SMURFCUTSEL, runEra);
        if ( run450)    doMassPoint(450.0, HWW_OPT_SMURFCUTSEL, runEra);
        if ( run500)    doMassPoint(500.0, HWW_OPT_SMURFCUTSEL, runEra);
        if ( run550)    doMassPoint(550.0, HWW_OPT_SMURFCUTSEL, runEra);
        if ( run600)    doMassPoint(600.0, HWW_OPT_SMURFCUTSEL, runEra);
    }

    //-- BDT --------------------------------------------------- 
    if (doBDT) {
        if ( run110)    doMassPoint(110.0, HWW_OPT_SMURFMVASEL, runEra);
        if ( run115)    doMassPoint(115.0, HWW_OPT_SMURFMVASEL, runEra);
        if ( run120)    doMassPoint(120.0, HWW_OPT_SMURFMVASEL, runEra);
        if ( run125)    doMassPoint(125.0, HWW_OPT_SMURFMVASEL, runEra);
        if ( run130)    doMassPoint(130.0, HWW_OPT_SMURFMVASEL, runEra);
        if ( run135)    doMassPoint(135.0, HWW_OPT_SMURFMVASEL, runEra);
        if ( run140)    doMassPoint(140.0, HWW_OPT_SMURFMVASEL, runEra);
        //      if ( run145)    doMassPoint(145.0, HWW_OPT_SMURFMVASEL, runEra);
        if ( run150)    doMassPoint(150.0, HWW_OPT_SMURFMVASEL, runEra);
        //      if ( run155)    doMassPoint(155.0, HWW_OPT_SMURFMVASEL, runEra);
        if ( run160)    doMassPoint(160.0, HWW_OPT_SMURFMVASEL, runEra);
        if ( run170)    doMassPoint(170.0, HWW_OPT_SMURFMVASEL, runEra);
        if ( run180)    doMassPoint(180.0, HWW_OPT_SMURFMVASEL, runEra);
        if ( run190)    doMassPoint(190.0, HWW_OPT_SMURFMVASEL, runEra);
        if ( run200)    doMassPoint(200.0, HWW_OPT_SMURFMVASEL, runEra);
        if ( run250)    doMassPoint(250.0, HWW_OPT_SMURFMVASEL, runEra);
        if ( run300)    doMassPoint(300.0, HWW_OPT_SMURFMVASEL, runEra);
        if ( run350)    doMassPoint(350.0, HWW_OPT_SMURFMVASEL, runEra);
        if ( run400)    doMassPoint(400.0, HWW_OPT_SMURFMVASEL, runEra);
        if ( run450)    doMassPoint(450.0, HWW_OPT_SMURFMVASEL, runEra);
        if ( run500)    doMassPoint(500.0, HWW_OPT_SMURFMVASEL, runEra);
        if ( run550)    doMassPoint(550.0, HWW_OPT_SMURFMVASEL, runEra);
        if ( run600)    doMassPoint(600.0, HWW_OPT_SMURFMVASEL, runEra);
    }
...
void doMassPoint(float analysis, Option option, RunEra runEra)
{
    ...
    SmurfSample *sample_top_var         = new SmurfSample(option, TOPALTER, kMagenta, "TopVar");
    SmurfSample *sample_wwmcnlo         = new SmurfSample(option, WWMCNLO, kBlue+2, "WWMCNLO");
    SmurfSample *sample_wwmcnlo_up      = new SmurfSample(option, WWMCNLOUP, kBlue+2, "WWMCNLOUp");
    SmurfSample *sample_wwmcnlo_down    = new SmurfSample(option, WWMCNLODOWN, kBlue+2, "WWMCNLODown");
    SmurfSample *sample_wjets_mc        = new SmurfSample(option, WJETS, kCyan, "WjetsMC");
    SmurfSample *sample_wjets_mc_loose  = new SmurfSample(option, WJETSMCLOOSE, kCyan, "WjetsMCLoose");    
    SmurfSample *sample_dyll_data       = new SmurfSample(option, ZLLDATA, kBlue, "DYLLDATA");
    ...
    if ( skimdata ) {
        ...
        for ( int jetbin = 0; jetbin < 3 ; jetbin++) {
            ...
            if (option == HWW_OPT_SMURFPRESEL) { 
                sample_gghww->add(Form("%s/%ij/hww%i.root", dataDir, jetbin, 125));
                sample_qqhww->add(Form("%s/%ij/hww%i.root", dataDir, jetbin, 125));
                sample_whww->add(Form("%s/%ij/hww%i.root", dataDir, jetbin, 125));
                sample_zhww->add(Form("%s/%ij/hww%i.root", dataDir, jetbin, 125));
            }
            ...
            sample_zjets->add(Form("%s/%ij/wz.root", dataDir, jetbin));
            sample_zjets->add(Form("%s/%ij/zz.root", dataDir, jetbin));
            ...
            // shape variation
            sample_top_var->add(Form("%s/%ij/ttbar.root", dataDir, jetbin));
            sample_top_var->add(Form("%s/%ij/tw.root", dataDir, jetbin));
            sample_wwmcnlo->add(Form("%s/%ij/wwmcnlo.root", dataDir, jetbin));
            sample_wwmcnlo_up->add(Form("%s/%ij/wwmcnloup.root", dataDir, jetbin));
            sample_wwmcnlo_down->add(Form("%s/%ij/wwmcnlodown.root", dataDir, jetbin));

            // WJets MC
            sample_wjets_mc->add(Form("%s/%ij/wjets.root", dataDir, jetbin)); 
            sample_wjets_mc_loose->add(Form("%s/%ij/wjets_PassFail.root", dataDir,jetbin)); 
    ...
    if ( skimdatass ) {
        ...
        for ( int jetbin = 0; jetbin < 3 ; jetbin++) {
            ...
            sample_zjets->add(Form("%s/%ij/dyll_SS.root", dataDir, jetbin));
            sample_zjets->add(Form("%s/%ij/wz_SS.root", dataDir, jetbin));
            sample_zjets->add(Form("%s/%ij/zz_SS.root", dataDir, jetbin));

            sample_top->add(Form("%s/%ij/ttbar_powheg_SS.root", dataDir, jetbin));
            sample_top->add(Form("%s/%ij/tw_SS.root", dataDir, jetbin));

            sample_vv->add(Form("%s/%ij/wz_SS.root", dataDir, jetbin));
            sample_vv->add(Form("%s/%ij/zz_SS.root", dataDir, jetbin));
            sample_vv->add(Form("%s/%ij/www_SS.root", dataDir, jetbin));

            sample_wgamma->add(Form("%s/%ij/wgammafo_SS.root", dataDir, jetbin));
            sample_wgamma->add(Form("%s/%ij/zgammafo_SS.root", dataDir, jetbin));
            sample_wgammanorm->add(Form("%s/%ij/wgamma_SS.root", dataDir, jetbin));
            sample_wgammanorm->add(Form("%s/%ij/zgamma_SS.root", dataDir, jetbin));
            sample_wg3l->add(Form("%s/%ij/wglll_SS.root", dataDir, jetbin));
            ...
            sample_wjetsEle->add(Form("%s/%ij/wz_SS.root", dataDir, jetbin));
            sample_wjetsEle->add(Form("%s/%ij/zz_SS.root", dataDir, jetbin));
            sample_wjetsEle->add(Form("%s/%ij/wgamma_SS.root", dataDir, jetbin));
            sample_wjetsEle->add(Form("%s/%ij/zgamma_SS.root", dataDir, jetbin));
            sample_wjetsEle->add(Form("%s/%ij/wglll_SS.root", dataDir, jetbin));
            ...
            sample_wjetsMu->add(Form("%s/%ij/wz_SS.root", dataDir, jetbin));
            sample_wjetsMu->add(Form("%s/%ij/zz_SS.root", dataDir, jetbin));
            sample_wjetsMu->add(Form("%s/%ij/wgamma_SS.root", dataDir, jetbin));
            sample_wjetsMu->add(Form("%s/%ij/zgamma_SS.root", dataDir, jetbin));
            sample_wjetsMu->add(Form("%s/%ij/wglll_SS.root", dataDir, jetbin));
            sample_wjetsMu->add(Form("%s/%ij/dyll_SS.root", dataDir, jetbin));

            sample_data->add(Form("%s/%ij/data_SS.root", dataDir, jetbin));
    ...
    if ( skimwithmva) {
        ...
        if ( analysis > 0. ) {
            ...
            sample_gghww->addShapeVariation1D(QCDSCALEVAR,  "histo_ggH_CMS_hww_MVAggHBounding", true);
            sample_gghww->addShapeVariation1D(LEPEFFVAR,    "histo_ggH_CMS_hww_MVALepEffBounding", false);
            sample_gghww->addShapeVariation1D(LEPRESVAR,    "histo_ggH_CMS_hww_MVALepResBounding", true);
            sample_gghww->addShapeVariation1D(METVAR,       "histo_ggH_CMS_hww_MVAMETResBounding", true);
            sample_gghww->addShapeVariation1D(JETRESVAR,    "histo_ggH_CMS_hww_MVAJESBounding", false);

            for (int njet=0; njet < 3; njet++) 
                sample_qqhww->add(Form("%s/mva/%i/hww%i_%ij.root", dataDir, int(analysis), int(analysis), njet));
            sample_qqhww->addShapeVariation1D(LEPEFFVAR, "histo_qqH_CMS_hww_MVALepEffBounding", false);
            sample_qqhww->addShapeVariation1D(LEPRESVAR, "histo_qqH_CMS_hww_MVALepResBounding", true);
            sample_qqhww->addShapeVariation1D(METVAR, "histo_qqH_CMS_hww_MVAMETResBounding", true);
            sample_qqhww->addShapeVariation1D(JETRESVAR, "histo_qqH_CMS_hww_MVAJESBounding", false);

            for (int njet=0; njet < 3; njet++) 
                sample_zhww->add(Form("%s/mva/%i/hww%i_%ij.root", dataDir, int(analysis), int(analysis), njet));
            sample_zhww->addShapeVariation1D(LEPEFFVAR, "histo_ZH_CMS_hww_MVALepEffBounding", false);
            sample_zhww->addShapeVariation1D(LEPRESVAR, "histo_ZH_CMS_hww_MVALepResBounding", true);
            sample_zhww->addShapeVariation1D(METVAR, "histo_ZH_CMS_hww_MVAMETResBounding", true);
            sample_zhww->addShapeVariation1D(JETRESVAR, "histo_ZH_CMS_hww_MVAJESBounding", false);

            for (int njet=0; njet < 3; njet++) 
                sample_whww->add(Form("%s/mva/%i/hww%i_%ij.root", dataDir, int(analysis), int(analysis), njet));
            sample_whww->addShapeVariation1D(LEPEFFVAR, "histo_WH_CMS_hww_MVALepEffBounding", false);
            sample_whww->addShapeVariation1D(LEPRESVAR, "histo_WH_CMS_hww_MVALepResBounding", true);
            sample_whww->addShapeVariation1D(METVAR, "histo_WH_CMS_hww_MVAMETResBounding", true);
            sample_whww->addShapeVariation1D(JETRESVAR, "histo_WH_CMS_hww_MVAJESBounding", false);
        }
        ...
        if ( analysis < 200) 
            sample_qqww->addShapeVariation1D(LEPEFFVAR, "histo_qqWW_CMS_hww_MVALepEffBounding", true);
        else 
            sample_qqww->addShapeVariation1D(LEPEFFVAR, "histo_qqWW_CMS_hww_MVALepEffBounding", false);
        sample_qqww->addShapeVariation1D(LEPRESVAR, "histo_qqWW_CMS_hww_MVALepResBounding", true);
        sample_qqww->addShapeVariation1D(METVAR, "histo_qqWW_CMS_hww_MVAMETResBounding", true);
        sample_qqww->addShapeVariation1D(JETRESVAR, "histo_qqWW_CMS_hww_MVAJESBounding", false);
        ...
        if ( analysis < 200) 
            sample_ggww->addShapeVariation1D(LEPEFFVAR, "histo_ggWW_CMS_hww_MVALepEffBounding", true);
        else 
            sample_ggww->addShapeVariation1D(LEPEFFVAR, "histo_ggWW_CMS_hww_MVALepEffBounding", false);
        sample_ggww->addShapeVariation1D(LEPRESVAR, "histo_ggWW_CMS_hww_MVALepResBounding", true);
        sample_ggww->addShapeVariation1D(METVAR, "histo_ggWW_CMS_hww_MVAMETResBounding", true);
        sample_ggww->addShapeVariation1D(JETRESVAR, "histo_ggWW_CMS_hww_MVAJESBounding", true);
        ...
        for (int njet=0; njet < 2; njet++) {
            ...
            //sample_zjets->add(Form("%s/mva/%i/wz_%ij.root", dataDir, int(analysis), njet));
            //sample_zjets->add(Form("%s/mva/%i/zz_%ij.root", dataDir, int(analysis), njet));
        }
        ...
        //sample_zjets->add(Form("%s/mva/%i/wz_%ij.root", dataDir, 125, 2));
        //sample_zjets->add(Form("%s/mva/%i/zz_%ij.root", dataDir, 125, 2));
        ...
        sample_top->addShapeVariation1D(LEPRESVAR, "histo_Top_CMS_hww_MVALepResBounding", true);
        sample_top->addShapeVariation1D(METVAR, "histo_Top_CMS_hww_MVAMETResBounding", true);
        sample_top->addShapeVariation1D(JETRESVAR, "histo_Top_CMS_hww_MVAJESBounding", false);
        ...
        sample_vv->addShapeVariation1D(LEPEFFVAR, "histo_VV_CMS_hww_MVALepEffBounding", false);
        sample_vv->addShapeVariation1D(LEPRESVAR, "histo_VV_CMS_hww_MVALepResBounding", true);
        sample_vv->addShapeVariation1D(METVAR, "histo_VV_CMS_hww_MVAMETResBounding", true);
        sample_vv->addShapeVariation1D(JETRESVAR, "histo_VV_CMS_hww_MVAJESBounding", false);
    ...
    if (option == HWW_OPT_SMURFMVASEL || option == HWW_OPT_SMURFCUTSEL || option == HWW_OPT_SMURFMESEL ) {
        ...
        for (int jetbin = 0; jetbin < 3; ++jetbin) {
            ...
            if ( option == HWW_OPT_SMURFMESEL || option == HWW_OPT_SMURFMVASEL) {
                printShapeHistograms(samplesToTabulate, option, jetbin, analysis, cardDir,((1<<0)|(1<<3)), runEra);
                printShapeHistograms(samplesToTabulate, option, jetbin, analysis, cardDir, ((1<<1)|(1<<2)), runEra);
            }
        }
    ...
    if (makePlots_) {
        ...
        for (unsigned int j = 0; j < 2; ++j) {
            for (unsigned int i = 0; i < kLeptonTypes; ++i) {
                ...
                //if (! (i == fTOTAL || i == fOF || i == fSF || i == fEM)) continue;
                if ( i != fOF ) continue;
...
/*
                ...
                TCanvas *c_lr = makeHWWAnalysisStack(option, analysis, samplesToTabulate, ZLL,
                        f, i, j, "../hwwplots/", "ww_lr", "Matrix Element LR", lumi);
                c_lr->SaveAs(Form("../hwwplots/hww_analysis%i_%i_lr_%s_%s.png", option, int(analysis), types[i], jetbin_names[j]));
                c_lr->SaveAs(Form("../hwwplots/hww_analysis%i_%i_lr_%s_%s.eps", option, int(analysis), types[i], jetbin_names[j]));
                delete c_lr;
*/
                //
                // all output
...
/*
                c_pt1->SaveAs(Form("../hwwplots/hww_analysis%i_%i_ALL_%s_%s_pt1.png", option, int(analysis), types[i], jetbin_names[j]));
                c_pt2->SaveAs(Form("../hwwplots/hww_analysis%i_%i_ALL_%s_%s_pt2.png", option, int(analysis), types[i], jetbin_names[j]));
                c_dphi->SaveAs(Form("../hwwplots/hww_analysis%i_%i_ALL_%s_%s_dphi.png", option, int(analysis), types[i], jetbin_names[j]));
                c_mll->SaveAs(Form("../hwwplots/hww_analysis%i_%i_ALL_%s_%s_mll.png", option, int(analysis), types[i], jetbin_names[j]));
                c_mt->SaveAs(Form("../hwwplots/hww_analysis%i_%i_ALL_%s_%s_mt.png", option, int(analysis), types[i], jetbin_names[j]));
                c_met->SaveAs(Form("../hwwplots/hww_analysis%i_%i_ALL_%s_%s_met.png", option, int(analysis), types[i], jetbin_names[j]));
*/
/*
                TCanvas *c1_big = new TCanvas("c1_big", "c1_big", 800, 800);
                c1_big->Divide(2, 2);
                c1_big->cd(1);
                ...
                c1_big->SaveAs(Form("../hwwplots/hww_analysis%i_%i_ALL4_%s_%s.pdf", option, int(analysis), types[i], jetbin_names[j]));
                c1_big->SaveAs(Form("../hwwplots/hww_analysis%i_%i_ALL4_%s_%s.png", option, int(analysis), types[i], jetbin_names[j]));
*/

                TCanvas *c1_big = new TCanvas("c1_big", "c1_big", 1200, 800);
                c1_big->Divide(3, 2);
                c1_big->cd(1);
                ...
                delete c_pt1; delete c_pt2; delete c_mll; 
                delete c_mt; delete c_met; delete c_dphi; 
                delete c1_big;
...
/*
                ...
                TCanvas *c_met_lo = makeHWWAnalysisStack(option, analysis, samplesToTabulate, ZLL,
                        f, i, j, "../hwwplots/", "hww_bdtlo_met", "MET [GeV]", lumi);

                c_bdt_lo->SaveAs(Form("../hwwplots/hww_analysis%i_%i_ALL_%s_%s_bdt_lo.pdf", option, int(analysis), types[i], jetbin_names[j]));
                c_pt1_lo->SaveAs(Form("../hwwplots/hww_analysis%i_%i_ALL_%s_%s_pt1_lo.pdf", option, int(analysis), types[i], jetbin_names[j]));
                c_pt2_lo->SaveAs(Form("../hwwplots/hww_analysis%i_%i_ALL_%s_%s_pt2_lo.pdf", option, int(analysis), types[i], jetbin_names[j]));
                c_dphi_lo->SaveAs(Form("../hwwplots/hww_analysis%i_%i_ALL_%s_%s_dphi_lo.pdf", option, int(analysis), types[i], jetbin_names[j]));
                c_mll_lo->SaveAs(Form("../hwwplots/hww_analysis%i_%i_ALL_%s_%s_mll_lo.pdf", option, int(analysis), types[i], jetbin_names[j]));
                c_mt_lo->SaveAs(Form("../hwwplots/hww_analysis%i_%i_ALL_%s_%s_mt_lo.pdf", option, int(analysis), types[i], jetbin_names[j]));
                c_met_lo->SaveAs(Form("../hwwplots/hww_analysis%i_%i_ALL_%s_%s_met_lo.pdf", option, int(analysis), types[i], jetbin_names[j]));
                ...
                delete c_mll_lo; delete c_dphi_lo; delete c_met_lo; 
                //delete cbig_bdt_lo;
...
/*
        for (unsigned int i = 0; i < kLeptonTypes; ++i) {
            ...
            c_detajj->SaveAs(Form("../hwwplots/hww_analysis%i_%i_ALLjj_%s_%s_detajj.pdf", option, int(analysis), types[i], jetbin_names[2]));
            c_mjj->SaveAs(Form("../hwwplots/hww_analysis%i_%i_ALLjj_%s_%s_mjj.pdf", option, int(analysis), types[i], jetbin_names[2]));
...
*/
    ...
    //
    // same sign closure test documentation
    //

    if (option == HWW_OPT_SSCTL)
    {
        FILE *fout_ss;
        fout_ss = fopen (Form("SameSignClosureTest_%u_%u.tex", option, int(analysis)), "w");
        fprintf(fout_ss, "\\documentclass{cmspaper}\n");
        fprintf(fout_ss, "\\usepackage{graphicx}\n");
        fprintf(fout_ss, "\\begin{document}\n");
        fprintf(fout_ss, "\\title{Summary of Same Sign Closure Test Results}\n");
        fprintf(fout_ss, "\\tableofcontents\n");
        fprintf(fout_ss, "\\clearpage\n");
        fprintf(fout_ss, "\\section{Zero jet bin}\n");
        PrintSameSignClosureTest(option, 0, ((1<<fMM)|(1<<fME)|(1<<fEM)|(1<<fEE)), samplesToTabulate, fout_ss);
        PrintSameSignClosureTest(option, 0, ((1<<fTOTAL)), samplesToTabulate, fout_ss);
        fprintf(fout_ss, "\\begin{figure}[!hbtp]\n \\centering\n");
        fprintf(fout_ss, "\\includegraphics[width=.8\\textwidth]{../hwwplots/hww_analysis24_0_ALL4_incl_0j.pdf}\n");
        fprintf(fout_ss, "\\caption{Same Sign Closure Test in Zero Jet Bin.}\n \\end{figure}\n");
        fprintf(fout_ss, "\\begin{figure}[!hbtp]\n \\centering\n");
        fprintf(fout_ss, "\\includegraphics[width=.8\\textwidth]{../hwwplots/hww_analysis24_0_ALL4_of_0j.pdf}\n");
        fprintf(fout_ss, "\\caption{Same Sign Closure Test in Zero Jet Bin (DF).}\n \\end{figure}\n");
        fprintf(fout_ss, "\\begin{figure}[!hbtp]\n \\centering\n");
        fprintf(fout_ss, "\\includegraphics[width=.8\\textwidth]{../hwwplots/hww_analysis24_0_ALL4_sf_0j.pdf}\n");
        fprintf(fout_ss, "\\caption{Same Sign Closure Test in Zero Jet Bin (SF).}\n \\end{figure}\n");
        fprintf(fout_ss, "\\begin{figure}[!hbtp]\n \\centering\n");
        fprintf(fout_ss, "\\includegraphics[width=.8\\textwidth]{../hwwplots/hww_analysis24_0_ALL4_em_0j.pdf}\n");
        fprintf(fout_ss, "\\caption{Same Sign Closure Test in Zero Jet Bin (EM).}\n \\end{figure}\n");
        fprintf(fout_ss, "\\clearpage\n");
        fprintf(fout_ss, "\\section{One jet bin}\n");
        PrintSameSignClosureTest(option, 1, ((1<<fMM)|(1<<fME)|(1<<fEM)|(1<<fEE)), samplesToTabulate, fout_ss);
        PrintSameSignClosureTest(option, 1, ((1<<fTOTAL)), samplesToTabulate, fout_ss);
        fprintf(fout_ss, "\\begin{figure}[!hbtp]\n \\centering\n");
        fprintf(fout_ss, "\\includegraphics[width=.8\\textwidth]{../hwwplots/hww_analysis24_0_ALL4_incl_1j.pdf}\n");
        fprintf(fout_ss, "\\caption{Same Sign Closure Test in One Jet Bin.}\n \\end{figure}\n");
        fprintf(fout_ss, "\\begin{figure}[!hbtp]\n \\centering\n");
        fprintf(fout_ss, "\\includegraphics[width=.8\\textwidth]{../hwwplots/hww_analysis24_0_ALL4_of_1j.pdf}\n");
        fprintf(fout_ss, "\\caption{Same Sign Closure Test in One Jet Bin (DF).}\n \\end{figure}\n");
        fprintf(fout_ss, "\\begin{figure}[!hbtp]\n \\centering\n");
        fprintf(fout_ss, "\\includegraphics[width=.8\\textwidth]{../hwwplots/hww_analysis24_0_ALL4_sf_1j.pdf}\n");
        fprintf(fout_ss, "\\caption{Same Sign Closure Test in One Jet Bin (SF).}\n \\end{figure}\n");
        fprintf(fout_ss, "\\begin{figure}[!hbtp]\n \\centering\n");
        fprintf(fout_ss, "\\includegraphics[width=.8\\textwidth]{../hwwplots/hww_analysis24_0_ALL4_em_1j.pdf}\n");
        fprintf(fout_ss, "\\caption{Same Sign Closure Test in One Jet Bin (EM).}\n \\end{figure}\n");
        fprintf(fout_ss, "\\clearpage\n");
        fprintf(fout_ss, "\\section{Two jet bin}\n");
        PrintSameSignClosureTest(option, 2, ((1<<fMM)|(1<<fME)|(1<<fEM)|(1<<fEE)), samplesToTabulate, fout_ss);
        PrintSameSignClosureTest(option, 2, ((1<<fTOTAL)), samplesToTabulate, fout_ss);
        fprintf(fout_ss, "\\begin{figure}[!hbtp]\n \\centering\n");
        fprintf(fout_ss, "\\includegraphics[width=.8\\textwidth]{../hwwplots/hww_analysis24_0_ALL4_incl_2j.pdf}\n");
        fprintf(fout_ss, "\\caption{Same Sign Closure Test in Two Jet Bin.}\n \\end{figure}\n");
        fprintf(fout_ss, "\\begin{figure}[!hbtp]\n \\centering\n");
        fprintf(fout_ss, "\\includegraphics[width=.8\\textwidth]{../hwwplots/hww_analysis24_0_ALL4_of_2j.pdf}\n");
        fprintf(fout_ss, "\\caption{Same Sign Closure Test in Two Jet Bin (DF).}\n \\end{figure}\n");
        fprintf(fout_ss, "\\begin{figure}[!hbtp]\n \\centering\n");
        fprintf(fout_ss, "\\includegraphics[width=.8\\textwidth]{../hwwplots/hww_analysis24_0_ALL4_sf_2j.pdf}\n");
        fprintf(fout_ss, "\\caption{Same Sign Closure Test in Two Jet Bin (SF).}\n \\end{figure}\n");
        fprintf(fout_ss, "\\begin{figure}[!hbtp]\n \\centering\n");
        fprintf(fout_ss, "\\includegraphics[width=.8\\textwidth]{../hwwplots/hww_analysis24_0_ALL4_em_2j.pdf}\n");
        fprintf(fout_ss, "\\caption{Same Sign Closure Test in Two Jet Bin (EM).}\n \\end{figure}\n");
        fprintf(fout_ss, "\\end{document}\n");
        fclose(fout_ss);
        gROOT->ProcessLine(Form(".! pdflatex SameSignClosureTest_%u_%u.tex", option, int(analysis)));
        gROOT->ProcessLine(Form(".! pdflatex SameSignClosureTest_%u_%u.tex", option, int(analysis)));
    }
